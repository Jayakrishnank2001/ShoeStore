...
router.post('/show-revenue',adminAuth.noSession,adminController.showRevenue)
router.get('/salesReport',adminAuth.noSession,adminController.salesReportPage)
router.get('/filterSales',adminAuth.noSession,adminController.filterSalesReport)
router.get('/download-salesReport',adminAuth.noSession,adminController.downloadSalesReport)
